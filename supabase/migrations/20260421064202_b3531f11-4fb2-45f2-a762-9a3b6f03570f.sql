-- Re-programa el cron amb el cron_secret al body
SELECT cron.unschedule('daily-backup-3am');
...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    ...
    body := jsonb_build_object('tipo', 'automatico', 'cron_secret', 'pitchputt-vendrell-cron-2026')
  );
  $$
);